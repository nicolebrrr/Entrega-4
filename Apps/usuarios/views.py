...
from Apps.usuarios.authentication_mixins import Authentication
from Apps.usuarios.api.serializer import UsuarioTokenSerializer
...
class UserToken(Authentication, APIView):
    ...
    def get(self,request,*args,**kwargs):        
        try:
            ...
            user = UsuarioTokenSerializer(self.user)
            return Response({
